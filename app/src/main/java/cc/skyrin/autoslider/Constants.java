...
public class Constants {
    // Settings Keys
    public static final String SPF_NAME = "as_config";

    public static final String KEY_MIN_DUR_TIME = "KEY_MIN_DUR_TIME";
    public static final String KEY_MAX_DUR_TIME = "KEY_MAX_DUR_TIME";
